        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-primary leading-tight mb-4 sm:mb-6">
              ...
              <span className="text-primary-light"> simplifiez votre vie</span>
            </h1>
            ...
            <div className="flex items-center gap-4 sm:gap-8 mt-8 sm:mt-10 pt-6 sm:pt-10 border-t border-gray-200 flex-wrap">
              <div>
                <p className="text-2xl sm:text-3xl font-bold text-primary">Plusieurs</p>
                <p className="text-xs sm:text-sm text-muted">Professionnels</p>
              </div>
              <div>
          ...
          <div className="relative hidden lg:block">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-3 sm:p-4 flex items-center gap-3 max-w-[200px]">
              ...
              <div>
                <p className="font-semibold text-primary text-sm">Tri & Recyclage</p>
                <p className="text-xs text-muted">Écoresponsable</p>
              </div>
            </div>
          </div>
        </div>
